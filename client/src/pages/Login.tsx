    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-500 via-purple-600 to-blue-500">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8 animate-slide-up">
          ...
          <p className="text-blue-100 text-lg">Optimize your Google Business Profile</p>
        </div>
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-xl border border-white border-opacity-20 rounded-3xl p-8 text-center">
          ...
          <p className="text-blue-100 mb-8">Continue with your Google account to access your business dashboard</p>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          ...
          <div className="text-white">
            <div className="w-12 h-12 bg-white bg-opacity-20 rounded-2xl mx-auto mb-2 flex items-center justify-center">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H9a1 1 0 010 2H7.771l.062-.245.124-.49.497-.497.302-.302L8.771 12zM7 3.5A1.5 1.5 0 018.5 2h3A1.5 1.5 0 0113 3.5v1A1.5 1.5 0 0111.5 6h-3A1.5 1.5 0 017 4.5v-1z" clipRule="evenodd" />
              </svg>
            </div>
